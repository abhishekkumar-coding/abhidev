  ...
  return (
    <div id='home' className='w-full'>
      <div className='max-w-6xl py-40 md:py-0 flex flex-col justify-center items-center gap-4 mx-auto md:h-screen'>
        ...
        <a href="/Abhishek_Resume.pdf" download="Abhishek Resume" className='' target='_blank'><button className='py-2 px-3 transition-all duration-200 bg-[#1E40AF] mt-10 font-semibold border text-xl rounded-lg flex justify-center items-center gap-2 outline-none border-none hover:bg-[#1E3A8A] text-white'>Download CV <FaDownload />
        </button></a>
      </div>
    </div>
  )
